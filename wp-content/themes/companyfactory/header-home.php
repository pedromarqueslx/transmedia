        ...
        <nav class="navbar fixed-top">
            ...
            <div class="navbar-brand img-fluid">
                ...
                ============================================= -->
                 ...
                 <div class="Webook-logo-white">

                     <a href="<?php echo get_home_url() ?>" class="custom-logo-link" rel="home">

                         <img src="<?php echo $custom_logo_id_home; ?>" class="custom-logo" alt="WeBook" title="WeBook">
                 ...
                 <div class="Webook-logo-colors d-none">
                     ...
                     <a href="<?php echo get_home_url() ?>" class="" rel="home">
                        ...
                        <img src="<?php echo $image[0]; ?>" class="custom-logo" alt="WeBook" title="WeBook">
