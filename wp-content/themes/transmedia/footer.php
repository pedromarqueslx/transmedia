...
<footer>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 p-3">
                    ...
                    if( get_theme_mod( 'ju_btn_quote_handle' ) ){
                        ?>
                        <a class="btn btn-lg btn-block button-rate-us" href="<?php get_theme_mod( 'ju_btn_quote_link_handle' ); ?>" title="<?php echo get_theme_mod( 'ju_btn_quote_handle' ); ?>"><?php echo get_theme_mod( 'ju_btn_quote_handle' ); ?></a>
                        <?php
                    }
                    ?>
                ...
                <div class="col-sm-12 mt-0">
                    ...
                    <ul class="social-links text-center text-md-right mt-n4">
                        ...
                        if( get_theme_mod( 'ju_facebook_link_input_handle' ) ){
                            ?>
                            <li><a href="https://facebook.com/<?php echo get_theme_mod( 'ju_facebook_link_input_handle' ); ?>" target="_blank" title="Facebook"><div class="si-facebook"></div></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_instagram_handle' ) ){
                            ?>
                            <li><a href="https://instagram.com/<?php echo get_theme_mod( 'ju_instagram_handle' ); ?>" target="_blank" title="Instagram"><div class="si-instagram"></div></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_linkedin_handle' ) ){
                            ?>
                            <li><a href="https://linkedin.com/<?php echo get_theme_mod( 'ju_linkedin_handle' ); ?>" target="_blank" title="LinkedIn"><div class="si-linkedin"></div></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_youtube_handle' ) ){
                            ?>
                            <li><a href="https://youtube.com/<?php echo get_theme_mod( 'ju_youtube_handle' ); ?>" target="_blank" title="Youtube"><div class="si-youtube"></div></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_twitter_handle' ) ){
                            ?>
                            <li><a href="https://twitter.com/<?php echo get_theme_mod( 'ju_twitter_handle' ); ?>" target="_blank" title="Twitter"><div class="si-twitter d-none d-sm-block"></div></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_pinterest_handle' ) ){
                            ?>
                            <li><a href="https://www.pinterest.com/<?php echo get_theme_mod( 'ju_pinterest_handle' ); ?>" target="_blank" title="Pinterest"><div class="si-pinterest d-none d-sm-block"></div></a></li>
                            <?php
                        }
                        ?>
                    </ul>
                ...
                <div class="col-sm-12 col-md-4">
                    ...
                    <ul class="list-unstyled text-small pl-0 pl-md-2">
                        ...
                        if( get_theme_mod( 'ju_navigationpagemenu_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu1_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu1_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu1_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu1_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu2_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu2_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu2_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu2_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu3_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu3_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu3_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu3_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu4_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu4_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu4_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu4_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu5_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu5_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu5_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu5_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu6_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu6_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu6_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu6_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu7_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu7_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu7_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu7_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu8_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu8_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu8_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu8_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu9_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu9_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu9_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu9_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu10_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu10_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu10_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu10_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu11_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu11_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu11_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu11_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu12_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu12_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu12_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu12_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu13_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu13_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu13_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu13_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu14_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu14_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu14_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu14_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu15_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu15_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu15_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu15_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu16_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu16_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu16_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu16_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu17_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu17_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu17_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu17_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                        <?php
                        if( get_theme_mod( 'ju_navigationpagemenu18_handle' ) ) {
                            ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu18_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu18_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu18_handle' )); ?></a></li>
                            <?php
                        }
                        ?>
                    </ul>
                ...
                <div class="col-sm-12 col-md-4">
                    ...
                    <h5 class="pl-0 pl-md-2">
                        ...
                        if( get_theme_mod( 'ju_footelinkstitle_second_handle' ) ){
                            ?><?php echo get_theme_mod( 'ju_footelinkstitle_second_handle' ); ?>
                            <?php
                        }
                        ?>
                    </h5>
                    ...
                    if( get_theme_mod( 'ju_navigationpagemenu19_handle' ) ) {
                        ?><li><a href="<?php the_permalink ( get_theme_mod( 'ju_navigationpagemenu19_handle' )); ?>" title="<?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu19_handle' )); ?>"><?php echo get_the_title( get_theme_mod( 'ju_navigationpagemenu19_handle' )); ?></a></li>
                        <?php
                    }
                    ?>
                ...
                <div class="col-sm-12 col-md-4">
                    ...
                    <h5 class="pl-0 pl-md-2 pt-5">
                        ...
                        if( get_theme_mod( 'ju_rateus_handle' ) ){
                            ?><?php echo get_theme_mod( 'ju_rateus_handle' ); ?>
                            <?php
                        }
                        ?>
                    </h5>
                    ...
                    if( get_theme_mod( 'ju_google_handle' ) ){
                        ?>
                        <a class="btn btn-lg btn-block button-rate-us" href="https://g.page/<?php echo get_theme_mod( 'ju_google_handle' ); ?>" target="_blank" title="auf Google">auf Google</a>
                    ...
                    if( get_theme_mod( 'ju_facebook_handle' ) ){
                        ?>
                        <a class="btn btn-lg btn-block button-rate-us" href="https://facebook.com/<?php echo get_theme_mod( 'ju_facebook_handle' ); ?>" target="_blank" title="auf Facebook">auf Facebook</a>
            ...
            <div class="row">
                ...
                <div class="col-12 mt-n1">
                    ...
                    if ( get_theme_mod ( 'ju_footer-image_handle' )) {
                        ?><a href="<?php echo get_home_url(); ?>"><img src="<?php echo get_theme_mod( 'ju_footer-image_handle' ); ?>" alt="<?php
    ...
    <?php
        ...
        include( plugin_dir_path( __FILE__ ) . 'includes/front/go-to-top.php');
