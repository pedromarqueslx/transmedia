...
get_header ();?>
    ...
    <!-- Slider transmedia - First Position
    ============================================= -->
    <section id="section5" class="section-slider-posts" style="display: <?php the_field('section_slider_webook_first_position') ?>">
        <?php
    ...
    <!-- Slider transmedia - Second Position
    ============================================= -->
    <section id="section5" class="section-slider-posts" style="display: <?php the_field('section_slider_webook_second_position') ?>">
        <?php
    ...
    <!-- Landing Page Form
    ============================================= -->
    <section id="section5" class="section-travel-direction" style="display: <?php the_field('landing_page_form') ?>">
        <div class="container" style="background-color: #276d86;">
            <?php echo do_shortcode( '[contact-form-7 id="2639" title="Reisebüro Anmelde Formular"]' ); ?>
        </div>
    </section><!-- #content end -->
