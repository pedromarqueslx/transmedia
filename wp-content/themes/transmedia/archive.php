            ...
            <div class="row m-4">
                ...
                <div class="col-sm-12 col-md-12 p-4 d-flex justify-content-center">
                    ...
                    the_posts_pagination(
                        array(
                            'prev_text'          => '<span class="posts-pagination">' . __( '&laquo; Zurück', 'transmedia' ) . '</span>',
                            'next_text'          => '<span class="posts-pagination">' . __( 'Weiter &raquo;', 'transmedia' ) . '</span>',
                            'before_page_number' => '<span class="posts-pagination">' . __( 'Seite', 'transmedia' ) . ' </span>',
                        )
                    );
                    ?>
